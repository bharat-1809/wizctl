"""Scene management for WiZ lights."""
...
from wizctl.config import load_config, SceneConfig
from wizctl.core.light import LightController


class WizScene(IntEnum):
    """Built-in WiZ scene IDs."""
...
class SceneManager:
    ...
    async def apply_scene(cls, light_ip: str, scene_name: str) -> bool:
        ...
        try:
            ...
            if scene.color:
                ...
                await controller.set_temperature(
                    scene.temperature,
                    brightness=scene.brightness,
                )
    ...
    def apply_scene_sync(cls, light_name_or_ip: str, scene_name: str) -> bool:
        """Synchronous wrapper to apply a scene."""
